...
import { Home, Settings, BarChart4 } from "lucide-react";
          ...
          <div className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-1 xl:grid-cols-1">
            <Card>
              <CardHeader className="px-7">
                ...
                <CardDescription>
                  Bitcoin (BTC) is a decentralized currency that eliminates the
                  need for central authorities such as banks or governments by
                  using a peer-to-peer internet network to confirm transactions
